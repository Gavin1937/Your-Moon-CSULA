    ...
    <div class="the-content">
      <div class="row">
        ...
        <div class="col-xs-12 col-md-8">
          <h1>Welcome</h1>
          <p>Welcome to YourMoon, a web application inviting users to submit images of their Moon. 
             Explore your lunar captures with labels from NASA JPL's MoonTrek, aiding the 'MoonTrek 
             AR' team in gathering data.</p>
          ...
          <div class="card mt-4">
            ...
            <div class="card-body d-flex justify-content-center align-items-center flex-column">
              ...
              <div v-if="isExpanded">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam.</p>
                <p>Lorem ipsum dorlor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam.</p>
              </div>
              <button type="button" class="btn btn-secondary mt-1btn-md btn-block btn-warning" @click="toggleExpand">{{ isExpanded ? 'Read Less' : 'Read More' }}</button>
            </div>
          </div>
        </div>
      </div>
